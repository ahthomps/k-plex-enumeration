...
public:
    ...
    virtual long Run(std::list<std::list<int>> &cliques, std::vector<bool> const &nodes_status);
    ...
    long listAllMaximalCliquesDegeneracy(std::vector<std::list<int>> const &adjList, int size, std::vector<bool> const &nodes_status);
